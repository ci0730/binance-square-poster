...
5. 不要写「非投资建议」「DYOR」等免责声明（即使范文里有也请省略）
6. 只输出帖子正文，不要解释过程
7. 范文里的 XXXX、XX、XX.XX、$XX、XXX、2026.XX.XX 等是占位符，不是文风！成稿必须换成真实日期与【24h 行情】价格；禁止输出任何由字母 X 组成的占位
8. 行情价格必须与背景给出的数字完全一致，禁止杜撰、截断，禁止使用记忆中的过时价格（如 BTC=26000）
